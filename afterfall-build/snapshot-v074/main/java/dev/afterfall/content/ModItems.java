...
public final class ModItems {
    ...
    public static final DeferredItem<Item> PREFILTER_CARTRIDGE = ITEMS.register("prefilter_cartridge", () -> new Item(new Item.Properties().durability(FilterBank.MAX_PREFILTER)));
    public static final DeferredItem<Item> HEPA_FILTER_CARTRIDGE = ITEMS.register("hepa_filter_cartridge", () -> new Item(new Item.Properties().durability(FilterBank.MAX_HEPA)));
    public static final DeferredItem<Item> RAD_FILTER_CARTRIDGE = ITEMS.register("rad_filter_cartridge", () -> new Item(new Item.Properties().durability(FilterBank.MAX_RAD)));
