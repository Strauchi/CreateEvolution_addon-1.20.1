...
public final class RoomAtmosphere {
    ...
    public void updateVolume(int newVolume, double outsideDust, double outsideAirborneRadiation) {
        // A topology change must not invent contaminated air. If two sealed spaces become
        // connected, their concentrations are mixed explicitly before the door opens.
        // For all other volume changes we preserve the room concentration; exposure to the
        // wasteland is handled separately by exposeToOutside().
